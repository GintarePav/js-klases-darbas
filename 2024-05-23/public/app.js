...
function Item(id, name, price, salePrice) {
  this.id = id, this.name = name, this.regularPrice = price, this.salePrice = salePrice, this.printInfo = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var _this = this;
    var dateAndTime, response, data, forecastTimestamps;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          dateAndTime = new Date().toISOString().substring(0, 14);
          _context.next = 3;
        ...
        case 6:
          ...
          forecastTimestamps = forecastTimestamps.filter(function (timeStamp) {
            var apiDateAndTime = new Date(timeStamp.forecastTimeUtc).toISOString().substring(0, 14);
            if (apiDateAndTime === dateAndTime) {
              if (timeStamp.airTemperature <= 20) {
                //console.log(`${this.id}, ${this.name}, ${this.regularPrice}`)
                return "".concat(_this.id, ", ").concat(_this.name, ", ").concat(_this.regularPrice);
              } else {
                // console.log(`${this.id}, ${this.name}, ${this.salePrice}`)
                return "".concat(_this.id, ", ").concat(_this.name, ", ").concat(_this.salePrice);
              }
            }
          });
  ...
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          newItem = new Item(1, "duona", 1.20, 0.99);
          _context2.t0 = console;
          _context2.next = 4;
          return newItem.printInfo();
        case 4:
...
var student = new Student("Jonas", "Jonaitis", "JS");
// console.log(student);
var VipStudent = /*#__PURE__*/function (_Student) {
  function VipStudent(first, last, subject, status) {
    var _this2;
    _classCallCheck(this, VipStudent);
    _this2 = _callSuper(this, VipStudent, [first, last, subject]);
    _this2.status = status;
    return _this2;
  }
  _inherits(VipStudent, _Student);
  return _createClass(VipStudent);
}(Student);
var vipStudent = new VipStudent("Jonas", "Jonaitis", "JS", "Supervisor");
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = globalThis["webpackChunkjs_klases_darbas"] = globalThis["webpackChunkjs_klases_darbas"] || [];
